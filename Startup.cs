...
namespace MindHypertrophy
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseCors(builder =>
                builder.WithOrigins("https://mindhypertrophy.herokuapp.com", "http://mindhypertrophy.herokuapp.com", "https://mindhypertrophy.com", "http://mindhypertrophy.com", "http://localhost:3000")
            );
